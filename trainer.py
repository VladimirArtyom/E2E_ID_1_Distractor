...
def parse_argument() -> Namespace:
    ...
    parser.add_argument("--dataset_path", type=str, default="VosLannack/race_id_uncombined")
    ...
    parser.add_argument("--save_dir", type=str, default="/content/drive/MyDrive/Thesis/distractor_1_data/t5-base_1_e1")
    ...
    parser.add_argument("--logs_dir", type=str, default="/content/drive/MyDrive/Thesis/distractor_1_data/t5-base_1_e1/logs")
